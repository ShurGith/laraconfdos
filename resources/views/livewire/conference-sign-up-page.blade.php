<div class="bg-gray-900">
    <main>
            ...
            <div class="mx-auto max-w-7xl px-6 pb-24 pt-10 sm:pb-32 lg:flex lg:px-8 lg:py-40">
                <div class="mx-auto max-w-2xl shrink-0 lg:mx-0 lg:pt-8">
                    ...
                    <div class="mt-24 sm:mt-32 lg:mt-16">
                        <a href="#" class="inline-flex space-x-6">
                            <span
                                class="rounded-full bg-indigo-500/10 px-3 py-1 text-sm/6 font-semibold text-indigo-400 ring-1 ring-inset ring-indigo-500/20">What's new</span>
                ...
                <svg class="size-5 text-gray-500" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true"
                  ...
                  <path fill-rule="evenodd"
                    ...
                    <h1 class="mt-10 text-pretty text-5xl font-semibold tracking-tight text-white sm:text-7xl">Deploy to
                        the cloud with confidence</h1>
        ...
        <div class="mx-auto mt-8 max-w-7xl px-6 sm:mt-16 lg:px-8">
            <h2 class="text-center text-lg/8 font-semibold text-white">The world’s most innovative companies use our
                app</h2>
            <div
                ...
                <img class="col-span-2 max-h-12 w-full object-contain lg:col-span-1"
                     ...
                     width="158" height="48">
                <img class="col-span-2 max-h-12 w-full object-contain lg:col-span-1"
                     src="https://tailwindui.com/plus/img/logos/158x48/reform-logo-white.svg" alt="Reform" width="158"
                     height="48">
                <img class="col-span-2 max-h-12 w-full object-contain lg:col-span-1"
                     src="https://tailwindui.com/plus/img/logos/158x48/tuple-logo-white.svg" alt="Tuple" width="158"
                     height="48">
        ...
        <div class="relative isolate mt-32 px-6 py-32 sm:mt-56 sm:py-40 lg:px-8">
            ...
            <div class="mx-auto max-w-2xl text-center">
                ...
                <p class="mx-auto mt-6 max-w-xl text-lg/8 text-gray-300">Incididunt sint fugiat pariatur cupidatat
    ...
    <footer class="mx-auto max-w-7xl px-6 lg:px-8">
        <div class="border-t border-white/10 py-12 md:flex md:items-center md:justify-between">
            ...
            <p class="mt-8 text-center text-sm/6 text-gray-400 md:order-1 md:mt-0">&copy; 2024 Your Company, Inc. All
                rights reserved.</p>
        </div>
    </footer>
